...
Template Name: Infatoz - IT Solution & Technology HTML Template<
Author:  Gramentheme
Author URI: https://themeforest.net/user/gramentheme/portfolio
Developer: Shamiul Islam Shikhon
Version: 1.0.0
Description: Infatoz - IT Solution & Technology HTML Template<
        ...
        function mousecursor() {
            if ($("body")) {
                ...
                window.onmousemove = function(s) {
                    if (!e) e = document.querySelector(".cursor-inner");
                    if (!t) t = document.querySelector(".cursor-outer");
                    if (o) return;
                    if (t) t.style.transform = "translate(" + s.clientX + "px, " + s.clientY + "px)";
                    if (e) e.style.transform = "translate(" + s.clientX + "px, " + s.clientY + "px)";
                    n = s.clientY;
                    i = s.clientX;
                };
